...
updated_main_analyses_and_figures was getting rather long and unruly, so I split it into three scripts -- one focused on EDA and cluster analyses, one on trailing edge vs. persistent forest (this one), and one on climate and other scatterplots/regressions
